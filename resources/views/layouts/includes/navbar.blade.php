                    ...
                    <ul class="dropdown-menu navbar-dropdown-caret">
                        ...
                        <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="layouts" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item active" href="../demo/horizontal-slim.html">
...
{{--            <li class="nav-item"> <a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#searchBoxModal"><span class="d-inline-block" style="height:12px;width:12px;"><span data-feather="search" style="height:12px;width:12px;"></span></span></a></li>--}}
            ...
            <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0 white-space-nowrap" id="navbarDropdownUser" href="#!" role="button" data-bs-toggle="dropdown" aria-haspopup="true" data-bs-auto-close="outside" aria-expanded="false">{{ Auth::user()->name }} <span class="d-inline-block" style="height:10.2px;width:10.2px;"><span class="fa-solid fa-chevron-down fs-10"></span></span></a>
                <div class="dropdown-menu dropdown-menu-end navbar-dropdown-caret py-0 dropdown-profile shadow border" aria-labelledby="navbarDropdownUser">
                    <div class="card position-relative border-0">
                        <div class="card-body p-0">
                            <div class="text-center pt-4 pb-3">
                                <div class="avatar avatar-xl ">
                                    @if(!isset(Auth::user()->avater_path))
                                        <img class="rounded-circle border border-light border" src={{ asset('assets/img/defaults/default-user-thumbnail.jpg') }} alt="" />
                                    @else
                                        <img class="rounded-circle border border-light border" src={{ asset('storage/' . Auth::user()->avater_path) }} alt="" />
                                    @endif
                                </div>
                        ...
                        <div class="card-footer p-0 border-top border-translucent">
                            <ul class="nav d-flex flex-column my-3">
                                <li class="nav-item"><a class="nav-link px-3" href=""> <span class="me-2 text-body fas fa-edit" ></span>Change Password</a></li>
                            </ul>
                            <hr />
                            <div class="px-3">
