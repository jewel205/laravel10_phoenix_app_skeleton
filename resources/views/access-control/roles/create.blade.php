                                ...
                                <div class="col-12 p-5 pt-0">
                                    <form method="post" name="requestForm" id="requestForm" action="{{route('roles.store')}}">
                                        ...
                                        <div class="auth-form-box-2">
                                            ...
                                            <div class="row mt-2 mb-3">
                                                @foreach($permissions as $permission)
                                                    <div class="col-md-6 col-lg-4 col-sm-12">
                                                        <div class="form-check">
                                                            <input class="form-check-input individual-checkbox" id="permissions" name="permissions[]" type="checkbox" value="{{ $permission->id }}" />
                                            ...
                                            <button type="submit" class="btn btn-info float-end"><span class="fas fa-download"></span> Create Role</button>
                                        </div>
                                    </form>
