                        ...
                        <div class="row align-items-center gx-0 gy-7">
                            ...
                            <div class="col mx-auto">
                                <div class="col-12 p-5 pt-0">
                                    <form method="post" name="requestForm" id="requestForm" action="{{route('users.passwordUpdate', $user->id)}}">
                                        @csrf
                                        @method('PUT')
                                        <div class="auth-form-box-2">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control @error('password') is-invalid @enderror" type="password"  id="password" name="password" value="{{old('password')}}" placeholder="EXAMPLE">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control @error('phone') is-invalid @enderror" type="password"  id="confirm-password" name="confirm-password" value="{{old('confirm-password')}}" placeholder="EXAMPLE">
